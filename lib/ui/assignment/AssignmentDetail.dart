                              ...
                              child: Column(
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: getRow(key: 'Student', value: '${parent.studentName?? '...'}'),
                                  ),
                                  SizedBox(
                                  ...
                                  Container(
                                      ...
                                      child: Column(
                                        children: [
                                          getRow(key: 'Teacher', value: '${teacherName?? '...'}'),
                                          getRow(key: 'Assignment type', value: '${dataList[0]['assignment_type']?? '.. ..'}'),
                                        ],
                                      )),
                                  SizedBox(
                                    height: _height * 0.017,
                                  ...
                                  Container(
                                      ...
                                      child: Column(
                                        children: [
                                          ...
                                          getRow(key: 'Assigned Date', value: '${dataList[0]['assignment_date']?? '.. ..'}'),
                                          getRow(key: 'Due Date', value: '${dataList[0]['assignment_due_date']?? '.. ..'}'),
                                     parent.detailStatus == 3?getRow(key: 'Submission Date', value: '${parent.gradedAssignmentList[parent.detailIndex]['submission_date']?? '.. ..'}'): Center(),
                                  ...
                                  Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Helper.text(
                                              value: 'Description', fSize: _height * 0.027),
                                          SizedBox(
                                            height: _height * 0.017,
                                          ),
                                          Container(
                                  ...
                                  Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Helper.text(
                                              value: 'Attachments', fSize: _height * 0.027),
                                          SizedBox(
                                            height: _height * 0.017,
                                          ),
                      dataList[0]['document'] == null? Helper.text(
                      value: 'No attachments',
                      fSize: _height * 0.025, fColor: Colors.grey): Wrap(
                                              runSpacing: 5.0,
                                              children: List.generate(dataList[0]['document'].length, (index) {
                                                List temp =
                                                dataList[0]['document'][index].split('%');
                                                return InkWell(
                                                    onTap: () {},
                                                    child: Wrap(
                                                      children: [
      ...
      actions: [
        Padding(
          ...
          child: Column(
            ...
            children: [
                  Padding(padding: EdgeInsets.only(right: _height*0.0),
                  child: Helper.text(
                    value: '${parent.detailStatus == 3? AppConstants.GRADED :parent.detailStatus == 2? AppConstants.SUBMITTED : parent.detailStatus == 1? AppConstants.DUE: "Unknown"}',
                    fWeight: FontWeight.bold,
                    fColor: Colors.white,
                    fSize: _height * 0.03,
                  ),),
              parent.gradedAssignmentList.isEmpty?Helper.text(
                value: '(0/${dataList[0]['total_marks']}) ',
                fWeight: FontWeight.bold,
                fColor: Colors.white,
                fSize: _height * 0.025,
              ):parent.gradedAssignmentList[parent.detailIndex]['marks'] !=null || parent.gradedAssignmentList[parent.detailIndex]['marks'] != ""? Helper.text(
                value: '(${parent.gradedAssignmentList[parent.detailIndex]['marks']}/${dataList[0]['total_marks']}) ',
                fWeight: FontWeight.bold,
                fColor: Colors.white,
                fSize: _height * 0.025,
              ): Helper.text(
  ...
  void populateData({AccountProvider parent}) {
    ...
    if(parent.detailStatus == 3)
     ...
     Future.delayed(Duration(seconds: 1),(){
       try{
         DatabaseServices().teachers.doc(dataList[0]['teacher_id']).get().then((value) {
