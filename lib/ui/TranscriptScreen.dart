  ...
  Widget getTempExpansionTile(double _height) {
    return ExpansionTileCard(
      ...
      title: Row(
        children: [
          Text(
            '.....',
            style: TextStyle(
                fontSize: _height * 0.028, color: CustomColors.darkGreenColor),
          ),
          Spacer(),
          Helper.text(
              value: '.. ..', fSize: _height * 0.027, fWeight: FontWeight.w400),
        ],
      ),
      ...
      children: <Widget>[
        ...
        getUpperRow(
            text1: '.. ..', text2: '..', text3: '.. .', cInd: 1, bottom: false)
      ],
    );
  }
}
